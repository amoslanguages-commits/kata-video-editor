...
class NleInputToSceneLinearPass(
    private val colorManagementGlsl: String,
) : NleColorPass {
    override val id: String = "input_to_scene_linear"
    override val label: String = "Input To Scene Linear"
    ...
    private val program = NleShaderProgram(
        ...
        fragmentShaderSource = NleColorPipelineShaders.inputToSceneLinearFragment(
            colorManagementGlsl,
        ),
    )
    ...
    override fun render(
        ...
        NleGlError.check("NleInputToSceneLinearPass.render")
    }
